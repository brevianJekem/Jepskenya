        ...
        {STORE_ITEMS.map((item) => (
          <div key={item.id} className="bg-black border border-white/10 p-8 flex flex-col justify-between hover:border-white/30 hover:bg-[#14213d]/40 transition-all group">
            ...
            <div className="flex items-center gap-3 mt-8 pt-6 border-t border-white/10">
              <Link href={item.link} className="flex-1 text-center bg-white text-black hover:bg-[#14213d] hover:text-white border border-white py-2.5 text-xs tracking-wider uppercase font-semibold transition-colors">View Details</Link>
            </div>
          </div>
        ))}
      </section>
