...
const LAPTOP_DATA = [
  { id: 'pro-16', name: 'Pro Book 16', price: '$1,899', cpu: '16-Core', ram: '32GB', storage: '1TB SSD', display: '16" 120Hz', image: '/laptop.png' },
  { id: 'air-14', name: 'Air Book 14', price: '$1,299', cpu: '10-Core', ram: '16GB', storage: '512GB SSD', display: '14" Retina', image: '/laptop.png' },
  { id: 'studio-15', name: 'Studio Book 15', price: '$1,599', cpu: '12-Core', ram: '32GB', storage: '1TB SSD', display: '15.6" OLED', image: '/laptop.png' },
  { id: 'workstation', name: 'Linux Workstation', price: '$1,449', cpu: '12-Core', ram: '64GB', storage: '2TB SSD', display: '14" 120Hz', image: '/laptop.png' }
];
          ...
          <div key={laptop.id} className="bg-black border border-white/10 p-8 flex flex-col justify-between hover:border-white/30 hover:bg-[#14213d]/40 transition-all group">
            <div>
              ...
              <div className="relative w-full h-[180px] flex items-center justify-center my-6">
                <Image src={laptop.image} alt={laptop.name} width={300} height={180} className="object-contain group-hover:scale-105 transition-transform duration-300" />
              </div>
            ...
            <div className="flex items-center gap-3 mt-8 pt-6 border-t border-white/10">
              <button 
                ...
                type="button"
                className="flex-1 bg-white text-black hover:bg-[#14213d] hover:text-white border border-white py-2.5 text-xs tracking-wider uppercase font-semibold transition-colors cursor-pointer"
              >
                Add to Bag
              </button>
            </div>
